...
<!--alt+B 실행-->
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/main_com.css">
		...
		<script>
	        $(document).ready(function(){
	            $('#basic-url').blur(function(){
	                var link = $('#basic-url').val();
	                $('#corp-frame').attr('src', link); 
	            });
	        });
	    </script>
	        ...
	        <div id="sections">
	            ...
	            <div class="tab-content" id="myTabContent">
	                ...
	                <div class="tab-pane fade" id="company" role="tabpanel" aria-labelledby="company-tab">
	                    <!--left panel--><div id="corplink">
	                        <div id="iframeform" class="input-group mb-3">
	                            <div class="input-group-prepend">
	                                <span class="input-group-text" id="basic-addon3">링크 주소</span>
	                            </div>
	                            <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
	                        </div>
	                        <div><iframe id="corp-frame"></iframe></div>
	                    </div>
	                    <!--right panel--><div id="corpinfolist">
